...
export default function Footer() {
  return (
    <footer className="bg-slate-800 dark:bg-[#1f1f1f] text-white dark:text-[#d1d5db] mt-16 transition-colors duration-300 border-t border-gray-700 dark:border-white/10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="text-center">
          ...
          <p className="text-gray-300 dark:text-[#9ca3af] text-sm mb-4">
            Your daily source for CBSE announcements, board exam updates, results and education news.
          </p>
          <nav className="mb-4">
            <div className="flex flex-wrap items-center justify-center gap-2 text-sm text-gray-300 dark:text-[#9ca3af]">
          ...
          <p className="text-gray-400 dark:text-[#9ca3af] text-xs">
