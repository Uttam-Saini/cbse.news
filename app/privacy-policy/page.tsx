      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg prose-slate dark:prose-invert max-w-none">
            <p className="text-sm text-gray-500 dark:text-[#9ca3af] mb-8">
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-relaxed text-gray-700 dark:text-[#d1d5db] mb-4">
                CBSE.News may collect information that you provide directly to us, including but not limited to:
              </p>
              <ul className="list-disc list-inside space-y-2 text-base leading-relaxed text-gray-700 dark:text-[#d1d5db] ml-4">
            ...
            <div className="mt-12 pt-8 border-t border-gray-200 dark:border-white/10">
              <p className="text-base leading-relaxed text-gray-700 dark:text-[#d1d5db] mb-2">
