  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#202124] transition-colors duration-300">
      <div className="text-center">
        ...
        <h2 className="text-2xl font-semibold text-gray-700 dark:text-[#d1d5db] mb-4">Page Not Found</h2>
        <p className="text-gray-600 dark:text-[#9ca3af] mb-8">The page you&apos;re looking for doesn&apos;t exist.</p>
        <Link
          href="/"
