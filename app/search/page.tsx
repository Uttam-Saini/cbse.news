      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {!hasSearched ? (
          <div className="bg-white dark:bg-[#1f1f1f] rounded-xl border border-gray-200 dark:border-white/10 p-16 text-center">
            <p className="text-gray-500 dark:text-[#d1d5db] text-lg">Please enter a search query in the search bar above.</p>
          </div>
        ) : results.length === 0 ? (
          <div className="bg-white dark:bg-[#1f1f1f] rounded-xl border border-gray-200 dark:border-white/10 p-16 text-center">
            <p className="text-gray-500 dark:text-[#d1d5db] text-lg">No results found for &quot;{query}&quot;.</p>
            <p className="text-gray-400 dark:text-[#9ca3af] mt-2">Try different keywords or check your spelling.</p>
          </div>
        ) : (
